...
#             print("self.masklist_dict[keys_][filenum]",self.masklist_dict[keys_][filenum].keys())
...
#             print("loc_data.keys()",loc_data.keys())
            ...
            for keys_ in loc_data.keys():
                path__ = loc_data[keys_]
                if '/storage/ayantika/' in path__:
                    new_path__ = '/home/projects/medimg/ayantika/'+path__.split('/storage/ayantika/')[-1]
                else:
                    new_path__ = path__
                imgdata_, meta = self.loader(new_path__)
                
                
                path__ = loc_data_baseline[keys_]
                if '/storage/ayantika/' in path__:
                    new_path__ = '/home/projects/medimg/ayantika/'+path__.split('/storage/ayantika/')[-1]
                else:
                    new_path__ = path__
                    
                imgdata_baseline_, meta_baseline = self.loader(new_path__)
...
#             print(loc_mask)
            for keys_ in loc_mask.keys():
                path__ = loc_mask[keys_]
                if '/storage/ayantika/' in path__:
                    new_path__ = '/home/projects/medimg/ayantika/'+path__.split('/storage/ayantika/')[-1]
                else:
                    new_path__ = path__
                mask_data_, mask_meta = self.loader(new_path__)
                
                path__ = loc_mask_baseline[keys_]
                if '/storage/ayantika/' in path__:
                    new_path__ = '/home/projects/medimg/ayantika/'+path__.split('/storage/ayantika/')[-1]
                else:
                    new_path__ = path__
                
                mask_data_baseline_, mask_meta_baseline_ = self.loader(new_path__) 
