...
# from experiment_brats_reg import *
from experiment_ADNI import *
...
def AD_DAE_autoenc_130M():
    conf = AD_DAE_autoenc_base()
    conf.total_samples = 130_000_000
    conf.eval_ema_every_samples = 10_000_000
    conf.eval_every_samples = 10_000_000
    conf.name = 'AD_DAE_autoenc_130M'
    return conf
def AD_DAE_autoenc_base():
    conf = autoenc_base()
...
# # def brats_reg_autoenc():
# #     conf = ffhq128_autoenc_base()
# #     conf.total_samples = 15_400
# #     conf.eval_ema_every_samples = 1_400
# #     conf.eval_every_samples = 1_400
